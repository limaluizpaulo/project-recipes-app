...
const DrinkDetailsC = (props) => {
  ...
  console.log(item.listRecomendations);
  async function resultDrink() {
    ...
    setItem({ valueDrink: payload, listRecomendations });
  }
        ...
        { drink.map((drinkItem, index) => (
          <>
            ...
            <iframe
              ...
              allowFullScreen
            />
            {/* <CarroselComidas recomendations={ recomendationsList } /> */}
          </>
        ))}
      </div>
    );
...
export default connect(mapStateToProps, mapDispatchToProps)(DrinkDetailsC);
