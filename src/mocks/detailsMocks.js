...
export const pathname = '/bebidas/16134';

export const bebidaId = '16134';

export const btnVisible = true;
export const btnMessage = 'Iniciar Receita';

export const drinksById = [{ idDrink: '16134' }];
